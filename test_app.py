...
#             # Fetch the temperature value from the correct sensor
#             temperature_sensor = next((sensor for sensor in data['sensors'] if sensor['title'] == 'Temperatur'), None)
...
#                     # Extend the "recent" threshold to 24 hours for testing
#                     if current_time - measurement_time < timedelta(days=1):
...
#     else:
#         avg_temp = 0  # Set avg_temp to 0 if no temperatures are found
